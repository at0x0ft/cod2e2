...
generate_docker_compose() {
  ...
  local readonly development_container_context_path=$(calculate_relative_path $(dirname "${development_docker_compose_path}") "${development_container_context_absolute_path}")
